...
Two gems are provided: the nmatrix gem which provides core features, and the nmatrix-atlas gem which extends the nmatrix gem and provides advanced linear algebra operations via ATLAS. Available from the <tt>atlas_plugin</tt> branch of <tt>https://github.com/wlevine/nmatrix.git</tt>
