...
sparse matrices, written mostly in C and C++. It is part of the SciRuby
project.
...
to {BLAS}[http://en.wikipedia.org/wiki/Basic_Linear_Algebra_Subprograms]) first. Detailed directions can be
...
If you want to obtain the latest (development)code, you should generally do:
    ...
    gem install pkg/nmatrix-0.0.6.gem
...
The following features exist in the current version of NMatrix (0.0.5):
