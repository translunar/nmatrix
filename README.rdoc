...
However, you will need to install ATLAS with CBLAS first. Those directions can be found on our website.

NOTE: The above command will not give you 0.0.4, which is not yet complete. To obtain the latest code, you should use
