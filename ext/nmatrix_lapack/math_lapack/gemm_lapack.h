...
//this is identical to gemm_atlas.h, except for the namespace, should find a way to share code

#ifndef GEMM_LAPACK_H
# define GEMM_LAPACK_H

extern "C" {
#include "cblas_local.h"
}
...
}}} // end of namespace nm::math::lapack
